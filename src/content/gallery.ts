...
export const galleryItems: GalleryItem[] = [
    ...
    description: "Simple rotations extruded to evoke a delicate, colorful structure.",
    arms: 2,
    layers: 1,
    complexity: "simple",
  ...
  },
  {
    id: "twin-orbit",
    title: "Twin Orbit",
    description: "Two simple shapes touching noses, with contrasting colors and partial opacity.",
    arms: 3,
    layers: 2,
    complexity: "simple",
  ...
  {
    id: "aural-telemetry",
    title: "Aural Telemetry",
    description: "Multiple layers with varying line styles evoke emanations reaching outward.",
    arms: 4,
    layers: 4,
    complexity: "complex",
    colors: ["#67e8f9", "#a5b4fc"],
